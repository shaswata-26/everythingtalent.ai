...
export default function ThriveSection() {
  ...
  return (
    <section 
      className="relative z-20 mx-auto overflow-hidden bg-gradient-to-tr from-[#fffefe] via-[#ffecf9] to-[#eee1fc] pb-20 dark:from-black dark:via-slate-900 dark:to-slate-950" 
    ...
    >
      ...
      <div style={{ zIndex: '45 !important' }} className="relative mx-auto h-40 w-[1.5px] bg-gradient-to-t from-blue-500 via-purple-600 to-yellow-300/40 pt-1"></div>
      <div className="relative z-30 mb-16 flex justify-center" style={{ opacity: 1, transform: 'none' }}>
      ...
      <div className="container relative z-40 mx-auto max-w-7xl px-4">
        ...
        <div className="flex flex-row justify-center lg:flex-row-reverse lg:gap-20">
          {/* Text content */}
          <div className="lg:w-1/2 relative" style={{ opacity: 0, transform: 'translateY(20px)' }}>
              ...
              {values.map((value, index) => (
                ...
                >
                  <svg
                    ...
                    strokeLinecap="round"
                    strokeLinejoin="round"
                    className={`lucide lucide-${value.icon} mb-3 h-6 w-6 text-purple-400`}
                  >
